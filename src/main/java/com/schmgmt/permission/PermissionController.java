...
public class PermissionController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<PermissionResponse>>
    createPermission(@Valid @RequestBody PermissionCreateRequest request) {
    ...
    public ResponseEntity<ApiResponse<PermissionResponse>> updatePermissionStatus(@PathVariable Long primaryKey, @RequestParam boolean active) {
        ...
        ApiResponse<PermissionResponse> response = ApiResponse.<PermissionResponse>builder()
            .success(true)
            .message(active ? "Permission activated successfully" : "Permission deactivated successfully")
            .data(permission)
            .build();
